...
class AssociationStakeholderScreen extends StatefulWidget {
  ...
  const AssociationStakeholderScreen({
    super.key,
    required this.associationName,
  });

  @override
  State<AssociationStakeholderScreen> createState() =>
      _AssociationStakeholderScreenState();
}

class _AssociationStakeholderScreenState
    extends State<AssociationStakeholderScreen> {
  ...
  Future<void> _loadStakeholders() async {
    ...
    try {
      ...
      List<Stakeholder> hiveStakeholders = box.values
          .where((s) =>
              s.state == userState && s.association == widget.associationName)
          .toList();
    ...
    setState(() {
      filteredStakeholders = stakeholders.where((stakeholder) {
        return stakeholder.fullName
            ...
            stakeholder.ward.toLowerCase().contains(searchQuery.toLowerCase());
      }).toList();
    });
  }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (stakeholder.phoneNumber.isNotEmpty) ...[
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              searchQuery.isEmpty
                  ? 'There are no stakeholders in this association.'
